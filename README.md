...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/pyqode.qt-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/pyqode.qt-feedstock)
...
Once the `conda-forge` channel has been enabled, `pyqode.qt` can be installed with:

```
conda install pyqode.qt
```

It is possible to list all of the versions of `pyqode.qt` available on your platform with:
